-- Idempotent repair: re-create sync revision triggers if 036 partially applied.

DROP TRIGGER IF EXISTS sync_bump_tasks_ins;
DROP TRIGGER IF EXISTS sync_bump_tasks_upd;
DROP TRIGGER IF EXISTS sync_bump_tasks_del;
DROP TRIGGER IF EXISTS sync_bump_slots_ins;
DROP TRIGGER IF EXISTS sync_bump_slots_upd;
DROP TRIGGER IF EXISTS sync_bump_slots_del;
DROP TRIGGER IF EXISTS sync_bump_links_ins;
DROP TRIGGER IF EXISTS sync_bump_links_upd;
DROP TRIGGER IF EXISTS sync_bump_links_del;
DROP TRIGGER IF EXISTS sync_bump_list_items_ins;
DROP TRIGGER IF EXISTS sync_bump_list_items_upd;
DROP TRIGGER IF EXISTS sync_bump_list_items_del;
DROP TRIGGER IF EXISTS sync_bump_schedule_blocks_ins;
DROP TRIGGER IF EXISTS sync_bump_schedule_blocks_upd;
DROP TRIGGER IF EXISTS sync_bump_schedule_blocks_del;
DROP TRIGGER IF EXISTS sync_bump_task_category_ins;
DROP TRIGGER IF EXISTS sync_bump_task_category_upd;
DROP TRIGGER IF EXISTS sync_bump_task_category_del;
DROP TRIGGER IF EXISTS sync_bump_task_subcategory_ins;
DROP TRIGGER IF EXISTS sync_bump_task_subcategory_upd;
DROP TRIGGER IF EXISTS sync_bump_task_subcategory_del;
DROP TRIGGER IF EXISTS sync_bump_task_tag_ins;
DROP TRIGGER IF EXISTS sync_bump_task_tag_del;
DROP TRIGGER IF EXISTS sync_bump_task_categories_ins;
DROP TRIGGER IF EXISTS sync_bump_task_categories_upd;
DROP TRIGGER IF EXISTS sync_bump_task_categories_del;
DROP TRIGGER IF EXISTS sync_bump_task_subcategories_ins;
DROP TRIGGER IF EXISTS sync_bump_task_subcategories_upd;
DROP TRIGGER IF EXISTS sync_bump_task_subcategories_del;
DROP TRIGGER IF EXISTS sync_bump_task_tags_ins;
DROP TRIGGER IF EXISTS sync_bump_task_tags_upd;
DROP TRIGGER IF EXISTS sync_bump_task_tags_del;
DROP TRIGGER IF EXISTS sync_bump_task_blocks_ins;
DROP TRIGGER IF EXISTS sync_bump_task_blocks_upd;
DROP TRIGGER IF EXISTS sync_bump_task_blocks_del;
DROP TRIGGER IF EXISTS sync_bump_favorite_folder_ins;
DROP TRIGGER IF EXISTS sync_bump_favorite_folder_upd;
DROP TRIGGER IF EXISTS sync_bump_favorite_folder_del;
DROP TRIGGER IF EXISTS sync_bump_app_settings_ins;
DROP TRIGGER IF EXISTS sync_bump_app_settings_upd;
DROP TRIGGER IF EXISTS sync_bump_app_settings_del;
